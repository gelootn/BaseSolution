...
{
    public class RemoteDatatableColumnBuilder<TEntity, TProperty>: RemoteDatatableColumnBuilderBase<TEntity>, IRemoteDatatableColumnBuilder<TEntity, TProperty> where TEntity : class 
    {
