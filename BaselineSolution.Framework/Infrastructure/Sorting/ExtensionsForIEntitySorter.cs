...
namespace BaselineSolution.Framework.Infrastructure.Sorting
{
    ...
    {
        private static IEntitySorter<TEntity> InnerThenBy<TEntity, TKey>(
        ...
        public static IEntitySorter<TEntity> ThenBy<TEntity, TKey>(
            this IEntitySorter<TEntity> sorter, Expression<Func<TEntity, TKey>> keySelector)
        {
            return InnerThenBy(sorter, keySelector, SortDirection.Ascending);
        }
        ...
        public static IEntitySorter<TEntity> ThenByDescending<TEntity, TKey>(
            this IEntitySorter<TEntity> sorter, Expression<Func<TEntity, TKey>> keySelector)
        {
            return InnerThenBy(sorter, keySelector, SortDirection.Descending);
        }
