...
namespace BaselineSolution.Framework.Infrastructure.Sorting
{
    ...
    {
        private static IEntitySorter<TEntity> InnerOrderBy<TKey>(Expression<Func<TEntity, TKey>> keySelector,
            SortDirection sortDirection)
        {
            if (keySelector == null)
                throw new ArgumentNullException("keySelector");
            return new OrderByEntitySorter<TEntity, TKey>(keySelector, sortDirection);
        }
        ...
        {
            return InnerOrderBy(keySelector, SortDirection.Ascending);
        }
        ...
        {
            return InnerOrderBy(keySelector, SortDirection.Descending);
        }
